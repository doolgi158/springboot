...
public class BoardRepositoryTest {
    ...
    public void findByTitleContainingTest() {
        ...
        // 이름검색
        //List<Board> list = boardRepository.findByNameContainning("한봄");
        // 내용검색
        //List<Board> list = boardRepository.findByContentContainning("소망");
